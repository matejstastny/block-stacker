...
> [!NOTE]
> These images are low quality to increase the speed of loading them on Github. Look [here](./assets/hi-res/) or **click the image** for the high resolution version
